...
export function SearchTagResultBasic({ searchResults }) {
  ...
  const optionSelected = searchResults[0].optionTagF;
  const option = searchResults[0].option;

  const partiDeVorbire = DataPostag();
  let searchWord = searchResults[0].searchWord;
      ...
      <>
        <div className="px-2 flex flex-col gap-2">
          <div className="absolute left-2 top-1">
            <span className="font-roboto text-sm tracking-widest font-light text-gray-600">
              Partea de vorbire:{" "}
            </span>
            <span className="font-roboto text-sm tracking-widest font-normal text-[#7d33ff]">
              {option}
            </span>
          </div>
          ...
          {getCurrentPageResults().map((result, index) => (
            <div
              key={index}
              className="border-[1px] px-2 py-1 border-[#7e33ff89] rounded-sm relative"
            >
              <p className="absolute right-2 top-1 font-roboto text-sm font-light text-gray-600">
                {totalElementsPassed + index + 1}
              </p>
              ...
              <div className="flex s:gap-2 gap-0 s:flex-row flex-col">
                ...
                <p className="font-roboto text-sm font-normal text-black">
                  <span className="font-medium">Sursa: </span>
                  {result._id}
                </p>
                <p className="font-roboto text-sm font-normal text-black">
                  <span className="font-medium">Autor: </span>{" "}
                  {result.sentence._parser || "Unknown"}
                </p>
              </div>
              ...
              <p className="text-roboto font-normal text-base text-black">
                ...
                {result.sentence.word.map((word, index) => (
                  <span
                    key={word._id}
                    className={
                      word._postag.startsWith(optionSelected)
                        ? "text-[#7D33FF]"
                        : ""
                    }
                  >
                  ...
                  <div className="bg-[#ffffff] w-[90%] h-[90%] rounded fixed left-1/2 top-6 -translate-x-1/2 overflow-y-scroll z-40 shadow-sm shadow-white scroll-bar">
                    ...
                    <div className="px-2 mt-3">
                      ...
                      <p className="text-black font-roboto text-base font-normal">
                        Detalii despre partea de vorbire căutată:
                        <span className="text-[#7D33FF]"> {option}</span>
                      </p>
                      {result.sentence.word.map(
                        (word, index) =>
                          word._postag.startsWith(optionSelected) && (
                            <div key={index}>
                              <p className="font-normal text-base font-roboto text-black">
                                <span className="font-medium">Formă:</span>{" "}
                                {word._form}
                              </p>
                              <p className="font-normal text-base font-roboto text-black">
                                <span className="font-medium">Lemă:</span>{" "}
                                {word._lemma}
                              </p>
          ...
          {getCurrentPageResults().map((result, index) => (
            ...
            >
              ...
              <p className="text-roboto font-normal text-base text-black">
                ...
                if (
                  word._postag.startsWith(optionSelected) &&
                  word._form.toLowerCase().includes(searchWord.toLowerCase())
                ) {
                  return (
                    <span key={word._id} className={"text-[#7D33FF]"}>
                      {index > 0 && " "}
                      {word._form}
                    </span>
                  );
                  ...
                  <div className="bg-[#ffffff] w-[90%] h-[90%] rounded fixed left-1/2 top-6 -translate-x-1/2 overflow-y-scroll z-40 shadow-sm shadow-white scroll-bar">
                    ...
                    <div className="px-2 mt-3">
                      ...
                      {result.sentence.word.map(
                        (word, index) =>
                          word._postag.startsWith(optionSelected) && 
                          word._form.includes(searchWord) && (
                            <div key={index}>
                              <p className="font-normal text-base font-roboto text-black">
                                <span className="font-medium">Formă:</span>{" "}
                                {word._form}
...
export function SearchTagResultAdvanced({ searchResults }) {
  ...
  const optionSelected = searchResults[0].optionTagF;
  const option = searchResults[0].option;
  const optionAdvanced = searchResults[0].optionAdvanced;
  const partiDeVorbire = DataPostag();
  let searchWord = searchResults[0].searchWord;
  ...
  const handlePageChange = (page) => {
          ...
          {getCurrentPageResults().map((result, index) => (
            ...
            >
              ...
              <p className="text-roboto font-normal text-base text-black">
                ...
                if (
                  word._postag.startsWith(optionSelected) &&
                  word._form.toLowerCase().startsWith(searchWord.toLowerCase())
                  ) {
                  return (
                    <span key={word._id} className={"text-[#7D33FF]"}>
                      {index > 0 && " "}
                  ...
                  <div className="bg-[#ffffff] w-[90%] h-[90%] rounded fixed left-1/2 top-6 -translate-x-1/2 overflow-y-scroll z-40 shadow-sm shadow-white scroll-bar">
                    ...
                    <div className="px-2 mt-3">
                      ...
                      {result.sentence.word.map(
                        (word, index) =>
                          word._postag.startsWith(optionSelected) && 
                          word._form.startsWith(searchWord) && (
                            <div key={index}>
                              <p className="font-normal text-base font-roboto text-black">
                                <span className="font-medium">Formă:</span>{" "}
                                {word._form}
    ...
    } else if (optionAdvanced === "End-with") {
      return (
        <>
   <div className="px-2 flex flex-col gap-2">
          <div className="absolute left-2 top-1">
          ...
          {getCurrentPageResults().map((result, index) => (
            ...
            >
              ...
              <p className="text-roboto font-normal text-base text-black">
                ...
                if (
                  word._postag.startsWith(optionSelected) &&
                  word._form.toLowerCase().endsWith(searchWord.toLowerCase())
                  ) {
                  return (
                    <span key={word._id} className={"text-[#7D33FF]"}>
                      {index > 0 && " "}
                  ...
                  <div className="bg-[#ffffff] w-[90%] h-[90%] rounded fixed left-1/2 top-6 -translate-x-1/2 overflow-y-scroll z-40 shadow-sm shadow-white scroll-bar">
                    ...
                    <div className="px-2 mt-3">
                      ...
                      {result.sentence.word.map(
                        (word, index) =>
                          word._postag.startsWith(optionSelected) && 
                          word._form.endsWith(searchWord) && (
                            <div key={index}>
                              <p className="font-normal text-base font-roboto text-black">
                                <span className="font-medium">Formă:</span>{" "}
                                {word._form}
          ...
          {getCurrentPageResults().map((result, index) => (
            ...
            >
              ...
              <p className="text-roboto font-normal text-base text-black">
                ...
                if (
                  word._postag.startsWith(optionSelected) &&
                  word._form.toLowerCase() === searchWord.toLowerCase()
                  ) {
                  return (
                    <span key={word._id} className={"text-[#7D33FF]"}>
                      {index > 0 && " "}
                  ...
                  <div className="bg-[#ffffff] w-[90%] h-[90%] rounded fixed left-1/2 top-6 -translate-x-1/2 overflow-y-scroll z-40 shadow-sm shadow-white scroll-bar">
                    ...
                    <div className="px-2 mt-3">
                      ...
                      {result.sentence.word.map(
                        (word, index) =>
                          word._postag.startsWith(optionSelected) && 
                          word._form.toLowerCase() === searchWord && (
                            <div key={index}>
                              <p className="font-normal text-base font-roboto text-black">
                                <span className="font-medium">Formă:</span>{" "}
                                {word._form}
      ...
      return (
        <>
          <p className="text-center text-red-600">Ceva nu a mers bine...</p>
        </>
      );
    }
  }
