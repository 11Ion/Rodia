...
import { SearchTagsBasicFunction } from "./SearchTagFunction";
import { UploadData } from "../uploadData/UploadData";
import { SearchTagResultBasic } from "./SearchTagResult";

export function SearchTagBasic(){
    ...
    const submitHandler = async (event) =>{
        ...
        try{
            ...
            LoadData.forEach(data => {
                const dataResults = SearchTagsBasicFunction(data, value, option);
            ...
            >
                ...
                <p className="text-white font-roboto py-1 font-light w-full">Selectează partea de vorbire:</p>
                    ...
                    <div className="mt-2 flex flex-wrap">
                        <p className="text-white font-roboto py-1 font-light w-full">Introdu cuvântul căutat <span className="text-[#b9b9b9] text-sm">(opțional)</span> </p>
                        <input 
            ...
            <div className="mt-4">
                ...
                <>
                    <div className="bg-[#f8f8f8] rounded-sm s:pt-8 pt-14 pb-8 relative mt-4">
                        <SearchTagResultBasic searchResults={searchResults} />
                    </div>
                </>  
                )}
